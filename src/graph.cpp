...
std::vector<int> Graph::shortestPath(const int & indexI)
{
...
vtkSmartPointer<vtkPoints> Graph::getPointsPath(std::vector<int> path)
{
...
vtkSmartPointer<vtkPolyData> Graph::getDrawablePoints()
{
